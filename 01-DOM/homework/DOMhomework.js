...
document.querySelector("#createdBy").innerHTML =
  document.querySelector("#createdBy").innerHTML + " Lisandro Oviedo";
...
function addToDo() {
  // Tu código acá:
  var valor_input = document.getElementById("toDoInput");
  var nuevo_todo = new ToDo(valor_input.value);
  toDoItems.push(nuevo_todo);
  valor_input.value = "";
  displayToDos();
}
